...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. encontrar el pais del atleta\n");
	...
	/**
	 * Le pide el usuario el nombre de un atltea, y luego le muestra la
	 * nacionalidad del atleta.
	 */
	private void paisDelAtleta()
	{
		System.out.println("\n" + "El pais que represento el atleta" + "\n" );
		String nombre = input("Por favor ingrese el nombre del atlteta");
		String respuesta = calculadora.buscarNacionalidad(nombre).darNombre(); 
		if (respuesta != null ) {
			System.out.println("La nacionalidad del atleta es: " + respuesta );
		}
		else {
